...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( UserProfile userProfile)?  success,TResult Function( ErrorHandler errorHandler)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
return success(_that.userProfile);case Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( UserProfile userProfile)  success,required TResult Function( ErrorHandler errorHandler)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case Loading():
return loading();case Success():
return success(_that.userProfile);case Error():
return error(_that.errorHandler);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( UserProfile userProfile)?  success,TResult? Function( ErrorHandler errorHandler)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Loading implements UpdateProfileState {
  const Loading();
...
class Success implements UpdateProfileState {
  const Success(this.userProfile);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success&&(identical(other.userProfile, userProfile) || other.userProfile == userProfile));
}
...
@override
String toString() {
  return 'UpdateProfileState.success(userProfile: $userProfile)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $UpdateProfileStateCopyWith<$Res> {
...
class Error implements UpdateProfileState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Error&&(identical(other.errorHandler, errorHandler) || other.errorHandler == errorHandler));
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $UpdateProfileStateCopyWith<$Res> {
