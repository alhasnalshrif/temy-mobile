...
class TextStyles {
  ...
  static TextStyle font12DarkGreyRegular = const TextStyle(
    fontSize: 12,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.gray,
  );

  static TextStyle font12BlueRegular = const TextStyle(
    fontSize: 12,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.mainBlue,
  );
  ...
  static TextStyle font18DarkBold = const TextStyle(
    fontSize: 18,
    fontWeight: FontWeightHelper.bold,
    color: Colors.black,
  );
  ...
  static TextStyle font18WhiteMeduim = const TextStyle(
    fontSize: 18,
    fontWeight: FontWeightHelper.medium,
    color: Colors.white,
  );
